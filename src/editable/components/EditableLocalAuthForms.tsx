...
const inputClass = 'h-12 rounded-md border border-[#e6e4ed] bg-white px-4 text-base font-bold text-[#17104d] outline-none transition placeholder:text-[#aaa6bd] focus:border-[#ff2547]'
const buttonClass = 'inline-flex h-12 items-center justify-center rounded-md bg-[#ff2547] px-6 text-sm font-black uppercase tracking-[0.16em] text-white shadow-[0_10px_22px_rgba(255,37,71,0.22)] transition hover:-translate-y-0.5 disabled:opacity-60'
